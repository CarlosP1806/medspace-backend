...
(
    ...
    CURRENT_TIMESTAMP, 'TENANT', null, 'https://example.com/license1.pdf',
    4.5, 'cus_123tenant', 'pm_123tenant'
),
(
    'Landlord User', 'landlord@gmail.com', 'firebase-uid-landlord', 'https://example.com/landlord.jpg', '2222222222',
    CURRENT_TIMESTAMP, 'LANDLORD', null, null,
    null, 'cus_123landlord', 'pm_123landlord'
),
(
    'Analyst User', 'analyst@gmail.com', 'firebase-uid-analyst', 'https://example.com/analyst.jpg', '3333333333',

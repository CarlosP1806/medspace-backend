...
public class GetClinicByIdUseCase {
        ...
        public GetClinicDTO execute(Long id, ClinicQueryFilterDTO queryFilterDTO) {
                ...
                List<GetClinicPhotoDTO> photoDTOs = queryFilterDTO.getIncludePhotos()
                ...
                List<GetClinicAvailabilityDTO> availabilityDTOs =
                                queryFilterDTO.getIncludeAvailabilities()
                                                ? clinicAvailabilityService
                                                                .getAvailabilitiesByClinicId(id)
                                                                .stream()
